//WiFly_Uart_CMD_Test.ino
//Project Powder Horn, Team 221 Robotics LLC
//by spencer neilan, winter 2014
//This code tests the WiFly RN131C module if using a direct UART serial interface.
